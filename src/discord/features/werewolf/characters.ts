...
export const characters = new Map<Character, CharacterData>();

characters.set(Character.DOPPELGANGER, {
	description:
...
characters.set(Character.WEREWOLF, {
	description:
...
characters.set(Character.MINION, {
	description:
...
characters.set(Character.MASON, {
...
characters.set(Character.ROBBER, {
	description:
...
characters.set(Character.TROUBLEMAKER, {
...
characters.set(Character.DRUNK, {
	description:
...
characters.set(Character.INSOMNIAC, {
...
characters.set(Character.VILLAGER, {
	description:
...
characters.set(Character.HUNTER, {
...
characters.set(Character.TANNER, {
